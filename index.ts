...
import { Application, ConversationHistory, DefaultPromptManager, DefaultTurnState, OpenAIModerator, AI, AzureOpenAIPlanner } from '@microsoft/teams-ai';
...
console.log(`\nConfig, ${config.openAIKey} at endpoint ${config.openAIEndpoint}`);
